...
void BoxApp::Draw(const GameTimer&gt)
{
	...
	// Indicate a state transition on the resource usgae.
...
void BoxApp::BuildShadersAndInputLayout()
{
	...
	mpsByteCode = d3dUtil::CompileShader(L"Shader\colorr.hlsl", nullptr, "PS", "ps_5_0");
...
void BoxApp::BuildBoxGeometry()
{
	...
	CopyMemory(mBoxGeo->IndexBufferCPU->GetBufferPointer(), indices.data(), vbByteSize);
